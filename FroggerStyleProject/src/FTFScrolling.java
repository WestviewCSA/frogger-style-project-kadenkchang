...
public class FTFScrolling{
	...
	public FTFScrolling() {
		forward = getImage("/imgs/"+"FTF.png"); //load the image for Tree
	...
	public boolean collided(Minion minion) {
		...
		Rectangle thisObject = new Rectangle (x+20,y+45,width-40,height-35);
		//checks if intersection
		return main.intersects(thisObject);
	}
	
	//2nd constructor - setting x and y
	public FTFScrolling(int x, int y) {
	...
	public void paint(Graphics g) {
		...
		if(Frame.debugging) {
			...
			//g.drawRect(x+20, y+45, width-40, height-35);
			//break;
		//case 1:
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = FTFScrolling.class.getResource(path);
