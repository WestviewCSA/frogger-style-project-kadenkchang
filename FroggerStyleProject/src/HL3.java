...
public class HL3{
	...
	public boolean collided(Minion minion) {
		...
		Rectangle thisObject = new Rectangle (x+55, y, width-110, height-43);
		//checks if intersection
		return main.intersects(thisObject);
	}
	//2nd constructor - setting x and y
	public HL3(int x, int y) {
	...
	public void paint(Graphics g) {
		...
		//if(Frame.debugging) {
			...
			//g.drawRect(x+55, y, width-110, height-43);
			//break;
		//case 1:
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = HL3.class.getResource(path);
