...
public class Spawner{
	...
	public Spawner() {
		...
		forward = getImage("/imgs/"+"spawner.png"); //load the image for Tree
	...
	public boolean collided(Minion minion) {
		...
		Rectangle thisObject = new Rectangle (900, 735, 80, 100);
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = Spawner.class.getResource(path);
